            ...
            <div className="row gy-3">
              ...
              <div className="order-lg-last col-lg-5 col-sm-8 col-8">
                <div className="d-flex float-end">
                  <Link to="/user_profile" className="me-1 border rounded py-1 px-3 nav-link d-flex align-items-center">
                    <i className="fas fa-user-alt m-1 me-md-2" />
                    <p className="d-none d-md-block mb-0">Sign in</p>
                  </Link>
                  <Link to="/wishlist" className="me-1 border rounded py-1 px-3 nav-link d-flex align-items-center">
              ...
              <div className="col-lg-5 col-md-12 col-12">
                ...
                {isFocused && filteredProducts.length > 0 && (
                  <div className="search-results" style={{ position: "absolute", top: "100%", left: "0", width: "100%", zIndex: 100 }}>
                ...
                {/* Show message if no matching products */}
                {isFocused && filteredProducts.length === 0 && searchQuery && (
                  <div className="no-results" style={{ padding: "10px", marginTop: "5px", color: "red" }}>
                    No products found.
                  </div>
                )}
              </div>
          ...
          <div className="container justify-content-center justify-content-md-between">
            ...
            <div className="collapse navbar-collapse" id="navbarLeftAlignExample">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <NavLink to="/hot-offers" className="nav-link">Hot offers</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink to="/gift-boxes" className="nav-link">Gift boxes</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink to="/product_listing" className="nav-link">Products</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink to="/menu-item" className="nav-link">Menu item</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink to="/menu-name" className="nav-link">Menu name</NavLink>
                </li>
              </ul>
            </div>
          </div>
